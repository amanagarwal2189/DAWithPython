...
#get unique data
print("unique_enrolled_students : "+str(len(getUniqueSet(enrollments))))
print("unique_daily_engagements : "+str(len(getUniqueSet(dailyEngagements))))
print("unique_project_submissions: "+str(len(getUniqueSet(projectsubmissions))))
